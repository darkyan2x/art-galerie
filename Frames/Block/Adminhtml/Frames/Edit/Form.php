<?php
/**
 * ArtGalerie_Frames Add New Row Form Admin Block.
 * @category    ArtGalerie
 * @package     ArtGalerie_Frames
 * @author      ArtGalerie Software Private Limited
 *
 */
namespace ArtGalerie\Frames\Block\Adminhtml\Frames\Edit;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required'  => false,
                'frame_callback' => array($this, 'frame_image'),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('Frame Edge'),
                'required'  => false,
                'frame_callback' => array($this, 'frame_edge'),
            ]
        );
