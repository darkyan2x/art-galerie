 ...
 *
 */
namespace ArtGalerie\Grid\Block\Adminhtml\AcrylglasBilder\Edit;
    ...
    protected function _prepareForm()
    {
        ...
        if ($model->getId()) {
            $fieldset = $form->addFieldset(
                'base_fieldset',
                ['legend' => __('Edit Acrylglas Bilder'), 'class' => 'fieldset-wide']
            );
            $fieldset->addField('id', 'hidden', ['name' => 'id']);
        } else {
            $fieldset = $form->addFieldset(
                'base_fieldset',
                ['legend' => __('Add New Acrylglas Bilder'), 'class' => 'fieldset-wide']
            );
        }
