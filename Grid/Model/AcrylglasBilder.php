...
use ArtGalerie\Grid\Api\Data\AcrylglasBilderInterface;
 
class AcrylglasBilder extends \Magento\Framework\Model\AbstractModel implements AcrylglasBilderInterface
{
    /**
     * CMS page cache tag.
     */
    const CACHE_TAG = 'ag__dyn_pricing_acrylicglass_picture';
 
    /**
     * @var string
     */
    protected $_cacheTag = 'ag__dyn_pricing_acrylicglass_picture';
     ...
     * @var string
     */
    protected $_eventPrefix = 'ag__dyn_pricing_acrylicglass_picture';
    ...
    {
        $this->_init('ArtGalerie\Grid\Model\ResourceModel\AcrylglasBilder');
    }
    /**
     * Get Id.
     *
