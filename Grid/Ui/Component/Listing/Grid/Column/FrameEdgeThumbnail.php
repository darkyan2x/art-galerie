...
class FrameEdgeThumbnail extends \Magento\Ui\Component\Listing\Columns\Column
{
    const FRAME = 'frame_edge';

    const ALT_FIELD = 'frame_edge';
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                $filename = 'pub/media/'.$item['frame_edge'];
