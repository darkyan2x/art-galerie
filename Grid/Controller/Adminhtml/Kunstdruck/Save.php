...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!$data) {
            $this->_redirect('grid/kunstdruck/addnewkunstdruck');
            return;
        }
        try {
            ...
            $rowData->save();
            $this->messageManager->addSuccess(__('Kunstdruck has been successfully saved.'));
        } catch (\Exception $e) {
    ...
    {
        return $this->_authorization->isAllowed('ArtGalerie_Grid::kunstdruck/save');
    }
}