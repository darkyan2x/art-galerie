...
class AddNewAcrylglasBilder extends \Magento\Backend\App\Action
{
    /**
     ...
     */
    private $acrylglasbilderFactory;
    ...
    public function execute()
    {
       ...
       $title = $rowId ? __('').$rowTitle : __('Add New Acrylglas Bilder');
    ...
    {
        return $this->_authorization->isAllowed('ArtGalerie_Grid::acrylglasbilder');
    }
}