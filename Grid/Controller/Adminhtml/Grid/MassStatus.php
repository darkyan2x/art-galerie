...
use ArtGalerie\Grid\Model\ResourceModel\Grid\CollectionFactory;
...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection->getItems() as $record) {
            $record->setIsActive($statusValue);
    ...
    /**
     * Check Category Map recode update Permission.
     * @return bool
     */
    protected function _isAllowed()
    {
        return $this->_authorization->isAllowed('ArtGalerie_Grid::row_data_update');
    }
}