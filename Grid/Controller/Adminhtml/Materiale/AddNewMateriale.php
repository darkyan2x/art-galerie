...
class AddNewMateriale extends \Magento\Backend\App\Action
{
    /**
    ...
    public function execute()
    {
        ...
        if ($rowId) {
           ...
           $rowTitle = $rowData->getMateriale();
           if (!$rowData->getMaterialeId()) {
       ...
       $title = $rowId ? __('').$rowTitle : __('Add New Materiale');
    ...
    {
        return $this->_authorization->isAllowed('ArtGalerie_Grid::materiale');
    }
}