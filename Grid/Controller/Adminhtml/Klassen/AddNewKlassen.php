...
class AddNewKlassen extends \Magento\Backend\App\Action
{
    /**
    ...
    public function execute()
    {
       ...
       $title = $rowId ? __('').$rowTitle : __('Add New Klassen');
    ...
    {
        return $this->_authorization->isAllowed('ArtGalerie_Grid::klassen');
    }
}